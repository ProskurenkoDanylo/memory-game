        ...
        <main>
          <section>
            <Container>
              ...
              <Text alignment="center">
                Welcome to our exciting Memory Match game! Immerse yourself in
                the world of movies as you challenge your memory skills by
                matching iconic movie posters and characters. Test your
                knowledge and enjoy the thrill of uncovering beloved films in
                this addictive and visually captivating game.
              </Text>
            </Container>
          </section>
          <S.CompaniesBoard>
          ...
          <section>
            <Container>
              ...
              <Text alignment="center">
                Experience diverse modes in our game: Endless, Bomb Timer, and
                Super Powers. Test your memory skills without time constraints
                in Endless mode, race against the clock in Bomb Timer mode, or
                unleash your inner superhero with special abilities in Super
                Powers mode. Elevate your movie memory game experience now!
              </Text>
            </Container>
          </section>
          <section>
            <Container>
              ...
              <Text alignment="center">
                Experience movie memory mastery in our game's Easy, Medium, and
                Hard modes. Test your skills with progressively challenging
                levels, matching iconic movie posters and characters. Choose
                your mode, immerse yourself in the world of cinema, and enjoy
                the thrill of uncovering beloved films!
              </Text>
            </Container>
          </section>
          <section>
            <Container>
              ...
              <Text alignment="center">
                ...
                thrilling head-to-head duels, testing your movie memory prowess
                and aiming for the top spot on the leaderboard. Let the battle
                begin!
              </Text>
            </Container>
          </section>
          <section>
            <Container>
              ...
              <Text alignment="center">
                Sign in now to join the movie memory challenge and prove your
                skills as the ultimate champion!
              </Text>
              <S.CenteredDiv>
